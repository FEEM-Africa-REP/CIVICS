...
#%%
sh_tree.shock_calc(path=r'Shading Trees\Shock\Shading_trees.xlsx',Y=True)
# sh_tree.plot_dx()
...
#%%
sh_tree.shock_calc(path=r'Shading Trees\Shock\Shading_trees.xlsx',Z=True,VA=True,S=True)
...
# sh_tree.plot_ds(indicator='FAO Land')
#%%
sh_tree.sensitivity(path=r'Shading Trees\Shock\Shading_trees.xlsx')
