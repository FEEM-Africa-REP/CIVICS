...
amin = REP_CVX.C_SUT(path=r'Database\Kenya_2014_SAM.xlsx',unit='M KSH')
#%%
...
#%%
antar=[]
for key, value in amin.results['sensitivity_1'].items(): 
    if key != 'information':
        antar.append(amin.results['sensitivity_1'][key]['X_agg'].loc['Activities'].values-amin.X_agg.loc['Activities'].values)
#%%
